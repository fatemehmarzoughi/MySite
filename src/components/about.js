...
export function About(){
    ...
    return(
        <div className="container" id='about'>
            ...
            <div data-aos="zoom-in" className="row aboutUs-firstSection" style={isFarsi ? {direction : 'rtl'} : {direction : 'ltr'}}>
                <div className="col">
                ...
                <div className="row about_row">
                    <div data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="1000" style={{order : '1'}}  className="col" >
                    ...
                    <div data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="1000" style={{order : '2'}}  className="col" >
                    ...
                    <div data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="1000" style={{order : '3'}}  className="col" >
                ...
                <div className="row about_row">
                    <div data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="1000" className="col" >
